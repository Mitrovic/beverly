...
class DriverController extends Controller
{
    ...
    public function actionMpdfDemo1($id) {
        $pdf = new Pdf([
            ...
            'methods' => [
                'SetHeader' => ['Generated By: Beverly Freight INC||Generated On: ' . date("r")],
...
// Save the image in a defined path
    ...
    public function actionCreate()
    {
        $model = new Driver;
        $address = [new Address];
        $driver_custom_questions = new DriverCustomQestion();
            ...
            if ($valid) {
                ...
                try {
                    if ($flag = $model->save(false)) {
                        ...
                        $driver_custom_questions->driver_id = $model->id;
                        $driver_custom_questions->save(false);
                    }
                    if ($flag) {
